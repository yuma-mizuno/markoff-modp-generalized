...
import BGS.Markoff.MiddleGame.EulerSevenPairedMaximalDivisorCorvajaZannierEscape
...
/-- One exact Euler-seven paired middle-game step strictly increases the
maximum coordinate order. -/
theorem
